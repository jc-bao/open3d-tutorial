...
def process_single_fragment(fragment_id, color_files, depth_files, n_files,
                            n_fragments, config):
  """process a single fragment of a dataset.

  Args:
      fragment_id (_type_): _description_
      color_files (_type_): _description_
      depth_files (_type_): _description_
      n_files (_type_): _description_
      n_fragments (_type_): _description_
